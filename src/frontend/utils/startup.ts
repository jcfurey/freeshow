...
async function getStoredData() {
    sendMainMultiple([Main.SYNCED_SETTINGS, Main.STAGE, Main.PROJECTS, Main.OVERLAYS, Main.TEMPLATES, Main.EVENTS, Main.MEDIA, Main.THEMES, Main.BIBLE_STUDY, Main.DRIVE_API_KEY, Main.HISTORY, Main.CACHE, Main.USAGE])
